...
import { Users, Eye, EyeOff, Plus, X, DollarSign, Calendar, Tag } from 'lucide-react';
...
const USER_CREDENTIALS = {
  'arpan': { password: '123', role: 'Admin' },
  'palak': { password: '123', role: 'Admin' },
  'manan': { password: '123', role: 'Employee' },
  'khushi': { password: '123', role: 'Employee' },
  'arpit': { password: '123', role: 'Employee' },
};
...
export default function App() {
  ...
  const deleteExpense = async (expenseId) => {
    if (window.confirm('Delete this expense?')) {
      const updatedExpenses = currentUserData.expenses.filter(exp => exp.id !== expenseId);
      const updatedUserData = {
        ...currentUserData,
      ...
      if (upsertError) {
        console.error('Error deleting expense:', upsertError);
          ...
          <div className="bg-white p-6 rounded-2xl shadow-xl">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-50 rounded-lg p-3 text-center">
                <p className="text-xs text-gray-600 mb-1">Demo Accounts:</p>
                <div className="text-xs text-gray-500 space-y-0.5">
                  <p>arpan / 123 (Admin)</p>
                  <p>manan / 123 (Employee)</p>
                </div>
              </div>
            </div>
          </div>
                        ...
                        <div className="flex-1">
                          <div className="flex flex-wrap items-center gap-1.5 mb-1.5">
                            ...
                            <span className={`text-xs px-1.5 py-0.5 rounded-full ${
                              expense.userRole === 'Admin' ? 'bg-purple-100 text-purple-800' :
                              'bg-green-100 text-green-800'
                            }`}>
